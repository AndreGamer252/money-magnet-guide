    ...
    <div className={`mb-12 ${className}`}>
      <div className="flex items-center mb-6">
        <div className="bg-gradient-primary rounded-full w-16 h-16 flex items-center justify-center shadow-elegant mr-6">
          <span className="font-montserrat text-2xl font-bold text-gold">{number}</span>
        </div>
        <div className="flex-1 h-1 bg-gradient-gold"></div>
      </div>
      <h2 className="font-montserrat text-4xl md:text-5xl font-bold text-primary leading-tight">
        {title}
      </h2>
    </div>
  );
